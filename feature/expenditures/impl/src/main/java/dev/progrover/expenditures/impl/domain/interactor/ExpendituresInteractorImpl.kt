...
class ExpendituresInteractorImpl @Inject constructor(
    ...
    override suspend fun getExpenditures(accountId: Int, startDate: String?, endDate: String?): ApiResponse<Pair<String, List<Expenditure>>> =
        repository.getExpenditures(accountId, startDate, endDate)
}